  ...
  return (
    <>
      <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-[20px]">
        {jobList.map(item => {
          const workingFormList = workingForm.find(work => work.value === item.workingForm)?.label;
          ...
          return (
            ...
            >
              ...
              <h3 className="mt-[20px] mx-[16px] font-[700] text-[18px] text-[#121212] text-center whitespace-normal line-clamp-2">
                {item.title}
              </h3>
              ...
              <div className="mt-[6px] flex justify-center items-center gap-[8px] font-[400] text-[14px] text-[#121212]">
                <FaBriefcase className="text-[16px]" /> {workingFormList}
              </div>
              <div className="mt-[6px] flex justify-center items-center gap-[8px] font-[400] text-[14px] text-[#121212]">
